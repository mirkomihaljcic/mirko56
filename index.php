<html><head><Title>Prakticni</Title></head><body>  
<form method="post" action="?action=add">  
RB <input type="text" id="t_rednib"/></br>  
IME <input type="text" id="t_ime"/></br>  
PREZIME <input type="text" name="t_prezime" id="t_prezime"/></br>  
<input type="submit" name="Unesi Podatke" value="Submit" /></form>  
<?php
